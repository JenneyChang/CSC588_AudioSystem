...
void APIENTRY Engine::debug_callback(GLenum source, GLenum type, GLuint id, GLenum severity,
...
void Engine::onDebugMessage(GLenum source, GLenum type, GLuint id, GLenum severity,
